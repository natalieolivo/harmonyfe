...
(function (d) {
  var harmonyAPIPort = 9999;
  var usersEndpoint = '/users';
  var form = document.querySelector('#userForm');
  var jsonFormData; // I borrowed this ...
  ...
  var formToJSON = function formToJSON(formElements) {
    return [].reduce.call(formElements, function (data, element) {
  ...
  form.addEventListener('submit', function (event) {
    ...
    fetch("http://localhost:".concat(harmonyAPIPort).concat(usersEndpoint), {
      method: 'POST',
...
//# sourceMappingURL=/harmonyfe.e31bb0bc.js.map